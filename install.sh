...
url_stable="https://github.com/vsskorodumov-code-it/Hybrid_XKeen/releases/latest/download/xkeen.tar.gz"
url_beta="https://raw.githubusercontent.com/vsskorodumov-code-it/Hybrid_XKeen/main/test/xkeen.tar.gz"
archive_name="xkeen.tar.gz"
release_fix_url="https://raw.githubusercontent.com/vsskorodumov-code-it/Hybrid_XKeen/main/01_info_variable.sh"
